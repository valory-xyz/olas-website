...
// Balancer pool for on-chain OLAS/USD price. Used by Predict ROI (Omenstrat on Gnosis).
// Gnosis: OLAS-WXDAI (WXDAI ≈ 1 USD). Polystrat (Polygon) uses this same oracle (no OLAS/USD pool on Polygon).
