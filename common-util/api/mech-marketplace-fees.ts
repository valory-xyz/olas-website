import { CHAIN_CONFIG, FEE_LIVE_SINCE_SEC } from 'common-util/constants';
import {
  createStaleStatus,
...
// The canonical definition lives in constants.ts, so components can state the date
// without importing this module and its viem client.
