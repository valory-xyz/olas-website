...
const HeaderLeftContent = () => (
  <div className='lg:col-span-6 px-5 lg:p-0 lg:text-left w-auto mb-12'>
    ...
    <div className='flex flex-wrap justify-stretch gap-6'>
      ...
      <Button variant='ghostPrimary' size='xl' asChild className='grow lg:w-auto '>
    ...
    <div className='grid max-w-screen-xl lg:px-16 mx-auto lg:gap-8 xl:gap-0 lg:grid-cols-12 items-center'>
      <div className='lg:col-span-6 text-center px-5 lg:p-0 lg:text-left lg:w-6/7'>
        ...
        <p className='mb-20'>
          ...
          data sources with speed and skill. It's more than just a tool; it's your companion on your
          crypto trading journey.
        </p>

        <h1 className={`${SUB_HEADER_CLASS} mb-8`}>Get ready to participate in AI agent DeFi</h1>
        <p className='mb-8'>
          BabyDegen is designed for anyone ready to embrace the future of autonomous trading.
          Whether you're looking to safeguard your edge in an evolving market or eager to explore
          trading without the steep learning curve, BabyDegen is your gateway to the next generation
          of effortless trading. Experience hands-free success with this cutting-edge solution.
        </p>
      </div>
    ...
    <div className='px-8 py-12 lg:p-0 grid max-w-screen-xl lg:px-16 mx-auto lg:gap-8 xl:gap-0 lg:grid-cols-12 items-center'>
      <div className='lg:col-span-6 text-center px-5 lg:p-0 lg:text-left lg:w-6/7'>
        ...
        <p className='mb-8'>
          ...
          select DeFi protocols on Optimism Mainnet and Base, it offers a targeted approach to
          maximizing returns within these ecosystems.
        </p>
        <p className='mb-8'>
          The Optimus Agent is currently in alpha testing via Quickstart and currently supports key
          protocols like Balancer and Uniswap. It’s operational on Ethereum, Base, and Optimism.
          Looking ahead, it will expand to support any protocol that wishes to integrate.
        </p>
      </div>
    ...
    <div className='grid grid-cols-1 gap-8 md:grid-cols-2 max-w-screen-lg mx-auto'>
      {resources.map((resource, index) => (
        ...
        >
          ...
          >
            {resource.action.text} <MoveUpRight className='ml-2 inline' size={16} />
          </a>
        </div>
      ))}
    </div>
...
const howItWorksSteps = [
  {
    ...
    description: (
      <>
        ...
        <ExternalLink href='https://www.coingecko.com/' target='_blank' rel='noreferrer'>
          CoinGecko
        </ExternalLink>
    ...
    <div className='max-w-screen-lg mx-auto lg:px-50'>
      ...
      <div className='lg:mx-16'>
        <div className='list-decimal mb-6 mt-12 mb-12'>
          Once you've funded your account and activated BabyDegen, there's nothing more you need to
          do. But if you're curious about what happens behind the scenes, here's a closer look:
        </div>
