    ...
    <div className='grid max-w-screen-xl items-start mx-auto lg:px-12 lg:gap-8 lg:grid-cols-12 lg:items-top xl:gap-0'>
      <div className='md:mb-12 lg:col-span-6'>
        ...
        <Button asChild variant='default' size='xl' className='mt-6 w-full md:w-auto'>
          <Link href='/services/contribute#what-is-olas-contribute-service'>Learn how</Link>
        </Button>
      </div>
...
const HowItWorks = () => (
  <SectionWrapper customClasses='px-4 py-12 lg:px-24 lg:py-0' id='what-is-olas-contribute-service'>
  ...
  >
    <div className='grid max-w-screen-xl items-start mx-auto lg:px-12 lg:gap-8 lg:grid-cols-12 xl:gap-0'>
      <div className='pb-0 pr-0 lg:col-span-6 lg:pr-12'>
        ...
        <div className='flex flex-col gap-5'>
          <p className={TEXT_CLASS}>
            You can use this powerful autonomous service to track and enhance the contributions of
            your community members in your own ecosystem. By leveraging the Coordination Kit, you
            can deploy a similar system to measure impact of community contributions in your
            ecosystem.
          </p>
          <p className={TEXT_CLASS}>
            The Coordination Kit includes all the necessary code you need to set up this autonomous
            service within your ecosystem.
          </p>
          <p className={TEXT_CLASS}>
            Simply fork the existing code, adjust it to align with your parameters, and integrate
            it.
          </p>
        </div>
      </div>
