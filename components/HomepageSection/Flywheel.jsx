...
function Flywheel() {
  return (
    ...
    >
      ...
      <div className="text-paragraph mb-24 lg:w-1/2 mx-auto">
      ...
      <div className="p-8 sm:p-16 lg:p-24">
        <div className="text-2xl text-gray-600 mb-12 lg:w-1/2 mx-auto">
        ...
        <div className="text-2xl text-gray-600 lg:w-1/2 mx-auto mb-12">
