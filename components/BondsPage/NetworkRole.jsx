  ...
  return (
    <SectionWrapper customClasses="lg:p-24 px-4 py-12 text-center">
      ...
      <div className="text-3xl font-light tracking-tight text-gray-600 leading-normal mb-4 lg:w-3/4 mx-auto">
        Bonding plays an important role for Olas – it capitalizes the protocol. This capital – called protocol-owned liquidity – can be used to fund and maintain new services.
      </div>
    </SectionWrapper>
  );
}
