...
const body = (
  <div className="flex flex-col gap-5">
    ...
    <p className={pClass}>
      You can build full services, individual agents or even
      just AI tools and other code components.
    </p>
...
const BuildWithOlas = () => (
  <BasicSection sectionId={sectionId} heading={heading} image={image} body={body} />);
