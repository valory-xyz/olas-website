...
const programs = [
  ...
  },
  {
    ...
    image: "/images/build-page/academy-study.jpg",
    description:
...
export const NewToOlas = () => (
  ...
  >
    ...
    <div className="grid md:grid-cols-3 md:gap-x-4 gap-y-4 max-w-5xl max-w-full xl:mx-auto xl:w-[1200px]">
      {programs.map((item) => (
        <Card
          className="bg-gradient-to-t from-[#F8F9FC] to-[#FFFFFF] flex flex-col overflow-hidden w-full border-t border-[#FFFFFF] rounded-2xl"
          key={item.title}
        >
          <Image
            src={item.image}
