  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const tokenomicsResult = await tokenomicsContract.methods.mapEpochTokenomics(newEpoch).call();
        ...
        setEmissions(
          ...
          emissionsData.epoches.filter((epochEmissions) => epochEmissions.counter !== Number(newEpoch))
        );
        ...
        <div className='flex-row lg:grid grid-cols-1 lg:grid-cols-2 gap-8'>
          ...
          <div className='border rounded-lg mb-12 lg:mb-0 mb-8 lg:mb-0'>
            <div className='p-4 border-b'>
              ...
              <p className='text-slate-500'>What is the maximum amount of OLAS that can be minted by the protocol over time?</p>
            </div>
            <EmissionScheduleChart inflationForYear={inflationForYear} timeLaunch={timeLaunch} currentYear={currentYear} loading={loading} />
          </div>

          <div className='border rounded-lg mb-8 lg:mb-0'>
            <div className='p-4 border-b'>
              <h2 className='text-xl mb-2 font-bold'>Actual Emissions Schedule</h2>
              <p className='text-slate-500'>What is the actual amount of OLAS minted by the protocol per epoch?</p>
            </div>
            <div className='p-4'>
          ...
          <div className='flex flex-col border rounded-lg place-content-center text-center mb-8 lg:mb-0 py-6'>
            <div className='inline-block mx-auto mb-4'>
              <Image src='/images/olas-token-page/flipside.svg' width={60} height={60} alt='Flipside logo' />
            </div>

            <h2 className='text-xl mb-4 font-bold'>Dive into the current distribution details</h2>
            <a href={FLIPSIDE_URL} className='text-purple-500' rel='noopener noreferrer' target='_blank'>
          ...
          <div className='flex flex-col col-span-2 border rounded-lg py-6 px-4'>
            ...
            <div className='grid lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-1 gap-4'>
              <div className='flex flex-col gap-3'>
                ...
                <span>
                  <Link href='https://coinmarketcap.com/currencies/autonolas/' className='text-purple-600' target='_blank' rel='noopener noreferrer'>
                    CoinMarketCap ↗
                  </Link>
                </span>
                <span>
                  <Link href='https://www.coingecko.com/en/coins/autonolas' className='text-purple-600' target='_blank' rel='noopener noreferrer'>
                    CoinGecko ↗
                  </Link>
                </span>
              </div>
              <div className='flex flex-col gap-3'>
                ...
                <span>
                  <Link href='https://api.olas.autonolas.tech/total_supply' className='text-purple-600' target='_blank' rel='noopener noreferrer'>
                    Total Supply ↗
                  </Link>
                </span>
                <span>
                  <Link href='https://api.olas.autonolas.tech/circulating_supply' className='text-purple-600' target='_blank' rel='noopener noreferrer'>
                    Circulating Supply ↗
                  </Link>
                </span>
              </div>
