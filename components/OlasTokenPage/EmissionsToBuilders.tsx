...
export const EmissionsToBuilders = memo(({ emissions, loading }: EmissionsToBuildersProps) => {
  const devIncentivesPoints = getCumulativeEmissions(emissions, 'devIncentivesTotalTopUp');
  const availableDevIncentivesPoints = getCumulativeEmissions(emissions, 'availableDevIncentives');
  ...
  return (
    <div className="flex flex-col flex-auto p-4">
      ...
      <div className="flex gap-4 mb-6">
        ...
        />
        <LegendItem color={EMISSIONS_CHART_COLORS.devRewards.legend} label="Dev rewards claimed" />
      </div>
              ...
              data={{
                ...
                datasets: [
                  ...
                  },
                  {
                    ...
                    pointBackgroundColor: EMISSIONS_CHART_COLORS.devRewards.line,
