import { MECH_MARKETPLACE_URL, PEARL_YOU_URL_WITH_UTM_SOURCE } from 'common-util/constants';
      ...
      <div className="text-left mx-auto relative">
        ...
        <div className="flex flex-col md:flex-row gap-4 lg:gap-14 md:pt-14 relative z-10">
          ...
          <div className="flex flex-col justify-between max-w-[267px]">
            <div>
              <Image src="/images/agents/safe.png" alt="Safe" width={267} height={198} />
              <p className="-top-[35px] relative">
                They self-custody resources via a wallet. Olas agents use account abstraction (via{' '}
                <ExternalLink href="https://safe.global/">Safe</ExternalLink>).
              </p>
            </div>
            <div>
              <Image src="/images/agents/poaa.png" alt="PoAA" width={267} height={112} />
              <p className="-top-[30px] relative">
                They optionally earn rewards via <Link href="/staking">Olas Staking</Link>.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-between max-w-[267px]">
            <div>
              <Image src="/images/agents/registry.png" alt="Registry" width={267} height={276} />
              <p className="-top-[35px] relative">
                They are listed on a global agent directory called{' '}
                <SubsiteLink href={MECH_MARKETPLACE_URL}>Mech Marketplace</SubsiteLink>.
              </p>
            </div>
            <div>
              ...
              <p className="-top-[30px] relative">
                ...
                <SubsiteLink
                  href={`${PEARL_YOU_URL_WITH_UTM_SOURCE}&utm_campaign=agents&utm_content=agents-link`}
                >
