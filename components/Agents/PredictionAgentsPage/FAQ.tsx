...
const faq = [
  {
    ...
    desc: 'Omenstrat is an autonomous AI agent that participates in prediction markets on your behalf. It is designed to analyze real-time data, discover new markets, and place trades on future events without manual input.',
  },
  {
