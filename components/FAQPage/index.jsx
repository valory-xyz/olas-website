...
const FAQPage = () => (
  <div className="p-4 max-w-screen-sm mx-auto text-slate-800">
    ...
    <Question text="When was the DAO founded? When was the TGE?">
      Olas DAO was founded in 2022 with ~50 participants. When the DAO was founded all the founding members paid their share of the costs, in total it was
      {' '}
    ...
    <Question text="When was the LBP?">
      ...
      {' '}
      This LBP is the only one planned and was created by Valory to establish initial liquidity in a decentralized manner because
    ...
    <Question text="What’s this about a seed round?">
      Olas was founded as above and did not have a seed round. Valory, the dev company many of the founding members work from,
      {' '}
    ...
    <Question text="OLAS supply and unlocks">
      Various statistics about OLAS (inc. total supply, circulating supply, current holders, unlock schedules and more) are all live
      {' '}
      ...
      . veOLAS is the governance token, which anyone can get by locking OLAS to participate in governance. Governance proposals can be found on Snapshot
      {' '}
      ...
      . buOLAS is a vesting contract for the founding members. You can lock OLAS for veOLAS and check unlocks for your wallet
      {' '}
    ...
    <Question text="How does bonding and liquidity work on Olas?">
      ...
      ), but the community might create further resources to make them more accessible as time progresses. The promised
      {' '}
