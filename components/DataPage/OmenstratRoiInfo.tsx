...
export const OmenstratRoiInfo = () => {
  ...
  return (
    <SectionWrapper id="omenstrat-predict-roi">
      <h2 className={SUB_HEADER_LG_CLASS}>Omenstrat: Predict ROI</h2>
      ...
      <div className="space-y-6 mt-4">
        <p>
          ...
          shown per <b>time range</b> (7D / 30D / 90D / Year): prediction profit and costs are
        ...
        <p>
          Year is the last 365 days, or everything since the platform&apos;s first day while it is
          younger than that. Per-day mech request counts are only stored from late June 2026. For
          older days in the Year range they come from the marketplace subgraph&apos;s per-request
          records, counted on the day each request was made, which do not include off-chain
          requests. Those days leave the Year range by June 2027.
        </p>
        ...
        <p className="text-purple-600">
          Subgraph link:{' '}
          <SubgraphLink apiUrl={process.env.NEXT_PUBLIC_GNOSIS_MARKETPLACE_SUBGRAPH_URL}>
            Gnosis
          </SubgraphLink>
        </p>
        <CodeSnippet>
