...
import { MODIUS_FIXED_END_DATE_UTC, STAKING_SUBGRAPH_URLS } from 'common-util/constants';
  ...
  return (
    <SectionWrapper id="babydegen-metrics">
      ...
      <div className="space-y-6 mt-4">
        <p>
          This API aggregates Optimus agent metrics from the BabyDegen and Optimism staking
          subgraphs. Population metrics (daily APR projections, agent age, and funded AUM) are
          fetched from the BabyDegen subgraph, while staking reward snapshots come from the Optimism
          staking subgraph. Together with the live OLAS price, those datasets are used to compute
          the derived staking APR exposed on the BabyDegen economy page.
        </p>
        ...
        <p className="text-purple-600">
          Subgraph link{' '}
          <ExternalLink href={STAKING_SUBGRAPH_URLS.optimism}>Optimism Staking</ExternalLink>
        </p>
