...
export const PolystratBrierInfo = () => {
  ...
  const dailyBrierStats = getPolymarketDailyBrierStatsQuery({
    date_gte: 0,
    date_lte: 9999999999,
    first: 1000,
    skip: 0,
  ...
  return (
    <SectionWrapper id="polystrat-predict-brier">
      <h2 className={SUB_HEADER_LG_CLASS}>Polystrat: Predict Brier Score</h2>
