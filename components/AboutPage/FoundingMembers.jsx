    ...
    <div className=" max-w-[1096px] mx-auto mb-24 md:mb-[120px] gap-12 flex flex-col-reverse md:flex-row items-center md:items-start justify-between">
      ...
      <div className="md:max-w-[536px] flex flex-col gap-6">
        <h2 className={SUB_HEADER_MEDIUM_CLASS}>
          In 2021, a group of builders, innovators and dreamers realized, the
          world doesn’t just need powerful AI, it needs powerful AI that{' '}
          <span className="border-b-4 border-purple-300">
            belongs to everyone
          </span>
        </h2>
        <p>
          So, they envisioned something radical - an truly open network where
        ...
        <p>
          They called it Olas — crypto’s ocean of agents. And from a small DAO
          of 50, they created{' '}
          <span className="font-semibold">
            one of the very first project at the intersection of Crypto x AI.
          </span>
        </p>
      </div>
    </div>
