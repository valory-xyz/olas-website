      ...
      <div className="gap-6 flex flex-col items-center lg:flex-row lg:items-start justify-between">
        <div className="md:max-w-[536px] flex flex-col gap-6">
          ...
          <h2 className={SUB_HEADER_MEDIUM_CLASS}>
            Olas allows users to own their AI agents rather than renting them —
            by aligning incentives between users and businesses through a unique
            token model
          </h2>
          <p>
            Users run AI agents via Pearl, the Agent App Store, and benefit
            directly from their use.
          </p>
          <p>
            Businesses list their AI agents on Mech Marketplace, earning when
            their agents help user-owned AI agents achieve goals.
          </p>
          <p>
            As more users adopt agents via Pearl, demand for services on the
            Mech Marketplace grows — incentivizing businesses to create better,
            more useful agents.
          </p>
          <p>
