    ...
    <div className="md:hidden w-full h-[1420px] border border-t-1.5 mobile-roadmap-container relative">
      <table className="table-fixed w-full border border-slate-200 mobile-roadmap-table">
        ...
        <tbody>
          ...
          <tr>
            <TableCell column="pearl" showCheckmark>AI Agent Ownership</TableCell>
            <TableCell column="marketplace" showCheckmark>A2A Collaboration</TableCell>
          </tr>
          <tr>
            <TableCell column="pearl" showCheckmark>Simplified UX</TableCell>
            <TableCell column="marketplace" showCheckmark>Monetize Your Agent</TableCell>
          </tr>
          <tr>
            <TableCell column="pearl" showCheckmark>Human-like Utility</TableCell>
            <TableCell column="marketplace" showCheckmark>x402</TableCell>
          </tr>
          <tr>
            <TableCell column="pearl" showCheckmark>Web2 UX</TableCell>
            <TableCell column="marketplace" showCheckmark>Simplified Onboarding</TableCell>
          </tr>
          <tr>
            <TableCell column="pearl" showCheckmark>More Agents</TableCell>
            <TableCell column="marketplace" showCheckmark>Seamless Data Storage</TableCell>
          </tr>
          <tr>
            <TableCell column="pearl" showCheckmark>Multiple AI Agents</TableCell>
            <TableCell column="marketplace" showCheckmark>ERC-8004</TableCell>
          </tr>
          <tr>
            <TableCell column="pearl" showCheckmark>Open-source</TableCell>
            <TableCell column="marketplace" showCheckmark>Hire Mech Agents</TableCell>
          </tr>
          <tr>
            <TableCell column="pearl" showCheckmark>No-code Experience</TableCell>
          </tr>
          <tr>
