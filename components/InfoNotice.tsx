...
export const InfoNotice = () => (
  <div className="max-w-[1000px] mx-auto px-6 pt-8 pb-4 text-center text-sm text-gray-500">
    ...
    in any Member State of the European Union. Crypto in Motion is solely responsible for its
    content. OLAS is a crypto-asset: its value can go down as well as up and you may lose the
